...
```bash
curl https://sentvia-api-production.up.railway.app/v1/inboxes -H "Authorization: Bearer sv_live_…"
curl -X DELETE https://sentvia-api-production.up.railway.app/v1/inboxes/INBOX_ID -H "Authorization: Bearer sv_live_…"
```
